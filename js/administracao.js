...
btnCadastrarUsuario.addEventListener('click', function (event) {
    ...
    axios.post("http://172.16.10.12:8080/ServiceDesk_BACKEND/rest/usuario/novo", JSON.stringify(data), config)
...
axios.get("http://172.16.10.12:8080/ServiceDesk_BACKEND/rest/usuarios", config)
    .then(function (response) {
