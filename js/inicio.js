...
axios.get("http://172.16.10.12:8080/ServiceDesk_BACKEND/rest/chamados", configLocal)
...
axios.get("http://172.16.10.12:8080/ServiceDesk_BACKEND/rest/chamado/" + chamadoId, configLocal)
    .then(function (response) {
